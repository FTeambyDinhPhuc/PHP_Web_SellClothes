                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr id="product_<?php echo $v['product_id'] . '_' . $v['cart_product_size']; ?>">
                                            ...
                                            <td class="product-price product_price" id="product_price_<?php echo $v['product_id'] . '_' . $v['cart_product_size']; ?>" data-price="<?php echo $v['product_price']; ?>"><?php echo formatPrice($v['product_price']); ?><span>đ</span>
                                            </td>
                                            <td class="product-quantity">
                                                <input type="number" class="quantity-input" name="qty" style="width: 100px;" id="product_quantity_<?php echo $v['product_id'] . '_' . $v['cart_product_size']; ?>" value="<?php echo $v['cart_product_quantity']; ?>" min="1" onchange="update_cart(<?php echo $v['product_id'] . ', \'' . $v['cart_product_size'] . '\''; ?>, this.value)" />
                                            </td>
